                                    ...
                                    <tr class="enrollment-row">
                                        <td>
                                            <div class="student-info">
                                                ...
                                                <span
                                                    class="student-name"><?php echo htmlspecialchars($enrollment['student_name']); ?></span>
                                            </div>
                                        </td>
                                        <td class="student-email">
                                            <?php echo htmlspecialchars($enrollment['student_email']); ?></td>
                                        <td>
                                            <span
                                                class="class-badge"><?php echo htmlspecialchars($enrollment['class_name']); ?></span>
                                        </td>
                                        <td class="class-description">
                                            <?php echo htmlspecialchars($enrollment['class_description'] ?? 'No description'); ?>
                                        </td>
                                        <td>
                                            <div class="action-buttons">
                                                <button type="button"
                                                    onclick="removeEnrollment(<?php echo $enrollment['id']; ?>)"
