...
$filter_type = $_GET['type'] ?? 'all'; // all, quiz, assignment
...
if ($filter_type === 'quiz') {
    // Only quiz submissions
} elseif ($filter_type === 'assignment') {
    $quiz_submissions_query = "SELECT NULL LIMIT 0"; // No quiz submissions
}
...
if ($filter_type === 'assignment') {
    ...
    $assignment_submissions_query = "SELECT NULL LIMIT 0"; // No assignment submissions
}
        ...
        <main class="main-content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value"><?php echo $total_submissions > 0 ? round(($graded_count / $total_submissions) * 100) : 0; ?>%</div>
                    ...
                    <div class="filters-grid">
                        ...
                        <div class="filter-group">
                            ...
                            <select id="type" name="type" class="filter-select">
                                ...
                                <option value="quiz" <?php echo $filter_type === 'quiz' ? 'selected' : ''; ?>>Quizzes</option>
                                ...
                                <div class="submission-header">
                                    <div class="submission-info">
                                        ...
                                        <div class="submission-meta">
                                            ...
                                            <span><i class="fas fa-users"></i> <?php echo htmlspecialchars($submission['class_name']); ?></span>
                                            <span><i class="fas fa-calendar"></i> <?php echo date('M j, Y g:i A', strtotime($submission['submitted_at'])); ?></span>
                                        </div>
                                    </div>
