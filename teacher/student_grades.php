...
// Get quiz grades
$quiz_grades_query = "SELECT q.title, q.total_marks, qs.score, qs.percentage, qs.submitted_at, 
...
$quiz_grades_stmt = $conn->prepare($quiz_grades_query);
$quiz_grades_stmt->bind_param("ii", $student_id, $teacher_id);
$quiz_grades_stmt->execute();
$quiz_grades = $quiz_grades_stmt->get_result()->fetch_all(MYSQLI_ASSOC);

// Get assignment grades
$assignment_grades_query = "SELECT a.title, a.max_marks, asub.score as marks, asub.submitted_at,
                           s.name as subject_name, c.name as class_name
...
$assignment_grades_stmt = $conn->prepare($assignment_grades_query);
$assignment_grades_stmt->bind_param("ii", $student_id, $teacher_id);
$assignment_grades_stmt->execute();
$assignment_grades = $assignment_grades_stmt->get_result()->fetch_all(MYSQLI_ASSOC);
        ...
        <main class="main-content">
            ...
            <div class="summary-cards">
                <div class="summary-card">
                    ...
                    <div class="summary-value" style="color: <?php echo $overall_average >= 80 ? '#16a34a' : ($overall_average >= 60 ? '#f59e0b' : '#dc2626'); ?>">
                ...
                <div class="summary-card">
                    ...
                    <div class="summary-value" style="color: <?php echo $quiz_average >= 80 ? '#16a34a' : ($quiz_average >= 60 ? '#f59e0b' : '#dc2626'); ?>">
                ...
                <div class="summary-card">
                    ...
                    <div class="summary-value" style="color: <?php echo $assignment_average >= 80 ? '#16a34a' : ($assignment_average >= 60 ? '#f59e0b' : '#dc2626'); ?>">
