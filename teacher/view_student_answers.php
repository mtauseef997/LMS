    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <div class="answers-header">
                ...
                <p><?php echo htmlspecialchars($quiz['title']); ?> - <?php echo htmlspecialchars($student['name']); ?>
                </p>
            </div>
            ...
            <div class="student-info">
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        <div class="info-value"><?php echo $submission['score']; ?>/<?php echo $quiz['total_marks']; ?>
                        </div>
                ...
                <?php foreach ($questions as $index => $question): ?>
                    ...
                    <div class="question-card <?php echo $is_correct ? 'correct' : 'incorrect'; ?>">
                        <div
                            ...
                            <div
                                style="background: #667eea; color: white; width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 600; font-size: 0.875rem;">
                                <?php echo $question_number; ?>
                            </div>
                            <div style="display: flex; align-items: center; gap: 1rem;">
                                <span
                                    style="padding: 0.25rem 0.75rem; border-radius: 12px; font-size: 0.75rem; font-weight: 600; text-transform: uppercase; <?php echo $is_correct ? 'background: #dcfce7; color: #166534;' : 'background: #fee2e2; color: #991b1b;'; ?>">
                                ...
                                <div
                                    ...
                                    <?php echo $is_correct ? $question['marks'] : 0; ?>/<?php echo $question['marks']; ?>
                                    marks
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            style="font-size: 1.1rem; font-weight: 600; color: #1f2937; margin-bottom: 1rem; line-height: 1.6;">
                            <?php echo nl2br(htmlspecialchars($question['question_text'])); ?>
                        </div>

                        <div style="margin-bottom: 1rem;">
                            <span style="font-weight: 600; color: #374151; margin-bottom: 0.5rem; display: block;">Student
                                Answer:</span>
                            <div
                                style="padding: 0.75rem; border-radius: 8px; background: #fef3c7; border: 1px solid #f59e0b; color: #92400e;">
                                <?php echo !empty($student_answer) ? nl2br(htmlspecialchars($student_answer)) : '<em>No answer provided</em>'; ?>
                            </div>
                        </div>

                        <div style="margin-bottom: 1rem;">
                            <span style="font-weight: 600; color: #374151; margin-bottom: 0.5rem; display: block;">Correct
                                Answer:</span>
                            <div
                                style="padding: 0.75rem; border-radius: 8px; background: #dcfce7; border: 1px solid #10b981; color: #166534;">
